// Gold Shield Vault — with Vanguard insurance & Valuation panel filled
...
btnLogin.addEventListener('click', async ()=>{
  ...
  if (h !== SEEDED_PWD_HASH){
    tries++;
    show(authMsg, tries>=5 ? 'Too many attempts. Try again shortly.' : 'Incorrect password.', true);
